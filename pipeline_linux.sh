...
project_path="/user/code/github/math-feedback/math-feedback/"
num_process=10
cd $project_path
...
backbone="tgi"
url="http://172.18.64.8:8080/generate"
max_words=$num_process
python Step3_JudgmentStepCalculatedCorrectly.py $source_folder $target_folder $num_parallel_process $backbone $url
...
python Step4_JudgmentStepReasoningCorrectly.py $source_folder $target_folder $num_parallel_process $backbone1 $url1 $backbone2 $url2
